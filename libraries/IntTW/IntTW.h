...
#include <Arduino.h>
 ...
 /*******************************/
#define INTTW_ACTION(address, rw) (uint8_t)((address << 1) | rw)
...
/************************************************/
#define INTTW_DEST(count, dest)  (uint8_t)(count | dest)
...
public:
	...
	void setTxBuffer(const uint8_t* buff);
	...
	bool writeBytes(uint8_t address, uint8_t cmd, uint8_t count, const uint8_t* buff);
...
private:
	...
	bool canContinue(const uint8_t* nextCmdPtr);
