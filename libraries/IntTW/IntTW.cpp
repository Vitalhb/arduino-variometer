...
void IntTW::setTxBuffer(const uint8_t* buff)
{
...
bool IntTW::canContinue(const uint8_t* nextCmdPtr)
{
...
/* blocking functions */
/**********************/
bool IntTW::writeBytes(uint8_t address, uint8_t cmd, uint8_t count, const uint8_t* buff)
{
