...
void SerialNmea::rxCompleteVect(void)
{
	...
	else if (nmeaParseStep == NMEA_TAG_SIZE + 1) // wait for parity 
	{ //before or on asterisk
		if (c == '*')
		{
			parityTag = 0;
			nmeaParseStep++;
